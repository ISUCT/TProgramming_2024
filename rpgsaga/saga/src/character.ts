export class Character {
    ...
    public printOverallInfo(): void {
        if (0 < this.__intellect && this.__intellect < 11 &&
            0 < this.__psyche && this.__psyche < 11 &&
            0 < this.__physique && this.__physique < 11 &&
            0 < this.__motorics && this.__motorics < 11) {
            console.log(`Имя: ${this.__name}\nИнтеллект: ${this.__intellect}\nПсихика: ${this.__psyche}\nФизиология: ${this.__physique}\nМоторика: ${this.__motorics}\n`);
        } else {
            throw new Error("Параметры персонажа были заданы неверно: характеристики могут принимать значения только от 1 до 10.");
        }
    }
